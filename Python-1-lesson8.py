...
print(conclusion.format(city, data['main']['temp'])) 
...
if save_data == 'y' or 'Y':
    ...
    c = connect.cursor()
    if os.path.isfile('{}.db'.format(city)): 
        c.execute('''REPLACE INTO weather (id_города, Город, Дата, Температура, id_погоды) VALUES (?, ?, ?, ?, ?)''', \
